package com.artlite.cameraview.common;
...
public class GCCameraView extends FrameLayout implements View.OnClickListener {
     ...
     */
    public enum Flash {
        OFF(GCConstants.FLASH_OFF, R.drawable.ic_gflash_off),
        ON(GCConstants.FLASH_ON, R.drawable.ic_gflash_on),
        AUTO(GCConstants.FLASH_AUTO, R.drawable.ic_gflash_auto);
        /**
         * {@link Integer} value of the {@link Facing}
         */
        protected final int value;
    ...
    public interface OnCameraCallback {
         ...
         */
        void cameraViewFlashChanged(@NonNull GCCameraView cameraView,
                                    @NonNull Flash flash);
         ...
         */
        void cameraViewFacingChanged(@NonNull GCCameraView cameraView,
         ...
         */
        void cameraViewPictureTaken(@NonNull GCCameraView cameraView,
                                    @NonNull Uri uri);
     ...
     */
    protected GCCameraImplementation cameraView;
     ...
     */
    protected GCCameraImplementation.Callback cameraCallback;
     ...
     */
    public GCCameraView(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     */
    public GCCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void onInitializeView(Context context, @Nullable final AttributeSet attrs) {
        ...
        try {
            ...
            Log.e(GCCameraView.class.getSimpleName(), ex.toString());
        }
    }
    ...
    protected int getLayoutId() {
        return R.layout.layout_gcamera_force_view;
    }
     ...
     */
    @NonNull
    protected final GCCameraImplementation.Callback getCameraCallback() {
        if (this.cameraCallback == null) {
            this.cameraCallback = new GCCameraImplementation.Callback() {
                /**
    ...
    /**
     * Method which provide the configuring of the {@link GCCameraView} with callback
     *
    ...
    protected class SaveFileTask extends AsyncTask<Void, Void, Uri> {
         ...
         * Instance of the {@link WeakReference}
         */
        private final WeakReference<GCCameraView> viewWeakReference;
        ...
        public SaveFileTask(@NonNull byte[] bytes,
                            ...
                            @Nullable GCCameraView cameraView) {
            this.bytes = bytes;
        ...
        protected void onPostExecute(Uri uri) {
            ...
            final GCCameraView cameraView = (this.viewWeakReference == null)
