 ...
 */
public class GCameraViewV1 extends FrameLayout implements View.OnClickListener {
    ...
    public interface OnCameraCallback {
         ...
         *
         * @param cameraView instance of the {@link GCameraViewV1}
         * @param flash      instance of the {@link Flash}
         */
        void cameraViewFlashChanged(@NonNull GCameraViewV1 cameraView,
                                    @NonNull Flash flash);
         ...
         */
        void cameraViewFacingChanged(@NonNull GCameraViewV1 cameraView,
         ...
         */
        void cameraViewPictureTaken(@NonNull GCameraViewV1 cameraView,
                                    @NonNull Uri uri);
     ...
     */
    protected CameraViewV1 cameraView;
     ...
     */
    protected CameraViewV1.Callback cameraCallback;
     ...
     */
    public GCameraViewV1(Context context) {
        super(context);
     ...
     */
    public GCameraViewV1(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     */
    public GCameraViewV1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void onInitializeView(Context context, @Nullable final AttributeSet attrs) {
        ...
        try {
            ...
            Log.e(GCameraViewV1.class.getSimpleName(), ex.toString());
        }
    }
     ...
     */
    @NonNull
    protected final CameraViewV1.Callback getCameraCallback() {
        if (this.cameraCallback == null) {
            this.cameraCallback = new CameraViewV1.Callback() {
                /**
    ...
    /**
     * Method which provide the configuring of the {@link GCameraViewV1} with callback
     *
    ...
    protected class SaveFileTask extends AsyncTask<Void, Void, Uri> {
         ...
         * Instance of the {@link WeakReference}
         */
        private final WeakReference<GCameraViewV1> viewWeakReference;
        ...
        public SaveFileTask(@NonNull byte[] bytes,
                            ...
                            @Nullable GCameraViewV1 cameraView) {
            this.bytes = bytes;
        ...
        protected void onPostExecute(Uri uri) {
            ...
            final GCameraViewV1 cameraView = (this.viewWeakReference == null)
